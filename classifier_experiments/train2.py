...
if __name__ == '__main__':
    ...
    # experiment 4 part 3
    train(data_dir, 0, [45, 60], 'dark_center',skeleton=True, shadow = True, shadow_ring = True)
    train(data_dir, 0, [45, 60], 'dark_background',skeleton=True, shadow = True, shadow_ring = True)
    
    train(data_dir, 0, [60, 75], 'dark_center',skeleton=True, shadow = True, shadow_ring = True)
    train(data_dir, 0, [60, 75], 'dark_background',skeleton=True, shadow = True, shadow_ring = True)
    
    train(data_dir, 0, [75, 90], 'dark_center',skeleton=True, shadow = True, shadow_ring = True)
    train(data_dir, 0, [75, 90], 'dark_background',skeleton=True, shadow = True, shadow_ring = True)